      ...
      >
        ...
        <div className="card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 mb-4 bg-white dark:bg-dark-800 border border-dark-200 dark:border-dark-700 rounded-lg hover:bg-dark-50 dark:hover:bg-dark-700 transition-colors"
          >
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white dark:bg-dark-900 text-dark-500">or continue with email</span>
            </div>
          </div>
